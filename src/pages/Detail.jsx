...
const Detail = () => {
  ...
  const allStats = [
    { label: 'HP',       value: hp,    max: 255, color: '#ef4444' },
    { label: 'ATK',      value: atk,   max: 190, color: '#f97316' },
    { label: 'DEF',      value: def,   max: 230, color: '#3b82f6' },
    { label: 'SP.ATK',   value: spAtk, max: 194, color: '#a855f7' },
    { label: 'SP.DEF',   value: spDef, max: 230, color: '#22c55e' },
    { label: 'SPD',      value: spd,   max: 180, color: '#06b6d4' },
  ];
